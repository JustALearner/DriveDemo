...
/***/ (function (module, exports) {
    ...
    $(document).ready(function () {
        ...
        $(".login-submit").click(function () {
            if (navigator.appName == "Microsoft Internet Explorer" && navigator.appVersion.match(/9./i) == "9.") {
                if ($(".register-phone").val() == $(".register-phone").attr("placeholder")) {
                    $(".register-phone").val("");
                }
                if ($("register-pwd").val() == $(".register-pwd").attr("placeholder")) {
                    $(".register-pwd").val("");
                }
                if ($(".register-code").val() == $(".register-code").attr("placeholder")) {
                    $(".register-code").val("");
                }
            }
            if (!phoneReg()) {
            ...
            if ($(".pwd-login-to").css("display") == "block") {
                ...
                //	                return false;
                //	            }
            } else if ($(".pwd-login-to").css("display") != "block") {
                if (!codeReg()) {
                    return false;
                }
            ...
            $.ajax({
                ...
                success: function success(res) {
                    ...
                    if (res.code == "0") {
                        ...
                        $(".register-phone").next().css("visibility", "visible");
                        $(".register-phone").next().text(res.msg);
                        $(".register-phone").next().next().hide();
                    } else if
                    (res.code == "-2") {
                        $(".register-pwd").next().css("visibility", "visible");
                        $(".register-pwd").next().text(res.msg);
                        $(".register-pwd").next().next().hide();
                    } else {
                        $(".register-phone").next().css("visibility", "visible");
                        $(".register-phone").next().text(res.msg);
                    ...
                    //	                    $(".register-pwd").next().text(res.msg);
                    //	                    $(".register-pwd").next().next().hide();
                    //	                    $(".register-code-btn").next().css("visibility", "visible");
                    //	                    $(".register-code-btn").next().text(res.msg);
                    //	                    $(".register-code-btn").next().next().hide();
                    //	                } else if (res.code == "1002") {
                    //	                    $(".register-code").next().next().css("visibility", "visible");
                    //	                    $(".register-code").next().next().text(res.msg);
                    //	                    $(".register-code").next().next().next().hide();
                    //	                } else if (res.code == "2" || res.code == "8") {
                    //	                    $(".register-pwd").next().css("visibility", "visible");
                    //	                    $(".register-pwd").next().text(res.msg);
                    //	                    $(".register-pwd").next().next().hide();
                    //	                    $(".register-code-btn").next().css("visibility", "visible");
